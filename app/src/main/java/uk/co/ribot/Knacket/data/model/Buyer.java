...
public class Buyer {
    ...
    public Buyer(Buyer buyer){
        ...
        this.category = buyer.getCategory();
        this.date = buyer.getDate();
        this.description = buyer.getDescription();
        this.price = buyer.getPrice();
        this.rating = buyer.getRating();
    }

    public ArrayList<Buyer> add3Buyers(){
        ArrayList<Buyer> buyers = new ArrayList<>();
        buyers.add(new Buyer("Andreas", "Hardcoded Buyer", "3-mar 17:05", "Soffa fatolj och sjrivbord skal slangas i grovsopor, bor pa 3tr grovosporna ligger isuefhisuhfiusehifuhseifuhseiufhseiufhiseuh", "300kr", 3));
        buyers.add(new Buyer("Pedro", "Hardcoded Buyer", "3-mar 17:05", "Soffa fatolj och sjrivbord skal slangas i grovsopor, bor pa 3tr grovosporna ligger isuefhisuhfiusehifuhseifuhseiufhseiufhiseuh", "3000kr", 10));
